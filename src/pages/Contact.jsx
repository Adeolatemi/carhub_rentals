// src/pages/Contact.jsx - Updated version
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Combine phoneCode and phone into a single phone field
    ...
    try {
      ...
      setStatus({ type: 'error', message: error.message || 'Failed to send message. Please try again or call us directly.' });
    } finally {
      setLoading(false);
    }
  };
